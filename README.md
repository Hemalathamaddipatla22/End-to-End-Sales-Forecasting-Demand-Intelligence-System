...
- 🔮 Multi-Model Sales Forecasting (SARIMA, Prophet & XGBoost)
...
│   ├── segment_forecast_comparison.png
│   ├── segment_growth_ranking.png
│   ├── xgboost_forecast.png
│   ├── xgboost_future_forecast.png
