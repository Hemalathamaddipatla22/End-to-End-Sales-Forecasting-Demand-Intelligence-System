...
st.caption(
    "An end-to-end demand intelligence system: exploratory analysis, 3-month sales "
    "forecasting (SARIMA / Prophet / XGBoost), anomaly detection, and product "
    "demand segmentation — built on 4 years of retail sales data."
)
...
st.sidebar.caption(
    "Explore sales trends, forecasts, anomalies, and product demand segments "
    "from 4 years of retail transaction data."
)
...
st.markdown(
    """
    <div style='text-align: center; color: gray; font-size: 0.85em; padding-top: 8px;'>
        Sales Forecasting & Demand Intelligence System &nbsp;|&nbsp;
        Built with SARIMA, Prophet, XGBoost, Isolation Forest & K-Means &nbsp;|&nbsp;
        Data: <a href="https://www.kaggle.com/datasets/rohitsahoo/sales-forecasting" target="_blank">Superstore Sales</a>
        &amp; <a href="https://www.kaggle.com/datasets/gregorut/videogamesales" target="_blank">Video Game Sales</a> (Kaggle)
        &nbsp;|&nbsp; <a href="https://github.com/Hemalathamaddipatla22/End-to-End-Sales-Forecasting-Demand-Intelligence-System" target="_blank">View source on GitHub</a>
    </div>
    """,
